...
public class Ulesanne1
{
    internal class StartClass
    {
        public static void Main(string[] args)
        {
            ...
            float laius = float.Parse(Console.ReadLine() ?? "0");
            ...
            if (vastus3.ToLower() == "jah")
            {
                ...
                float ruutmeeter = float.Parse(Console.ReadLine() ?? "0");
            ...
            float hind = float.Parse(Console.ReadLine() ?? "0");
            ...
            int pikk = int.Parse(Console.ReadLine() ?? "0");
            if (pikk < 165)
            {
            ...
            Console.WriteLine("Siseta teie pikkus cm");
            int pikk2 = int.Parse(Console.ReadLine() ?? "0");
